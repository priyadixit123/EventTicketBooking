...
contract EventTicketing is ERC721, Ownable, ReentrancyGuard {
    ...
    ) ERC721(eventName, "ETIX") Ownable(msg.sender) {
    ...
    function resellTicket(uint256 ticketId, uint256 resalePrice, address newOwner) public nonReentrant {
    ...
    // Refund ticket
    function refundTicket(uint256 ticketId) public nonReentrant onlyOwner {
    ...
    // Function to receive funds directly
